...
class GetCompletedOrdersModelData {
  ...
  List<BookingCompletedDeliveryAddress> bookingDeliveryAddresses;
  ...
  factory GetCompletedOrdersModelData.fromJson(Map<String, dynamic> json) =>
      GetCompletedOrdersModelData(
        ...
        bookingProducts: List<BookingCompletedProduct>.from(
        ...
        bookingDeliveryAddresses: List<BookingCompletedDeliveryAddress>.from(
            json["booking_delivery_addresses"]
                .map((x) => BookingCompletedDeliveryAddress.fromJson(x))),
...
class BookingCompletedDeliveryAddress {
  int id;
  String bookingId;
  String customerName;
  ...
  factory BookingCompletedDeliveryAddress.fromJson(Map<String, dynamic> json) =>
      BookingCompletedDeliveryAddress(
        id: json["id"] ?? 0,
        bookingId: json["booking_id"] ?? "",
...
class BookingCompletedProduct {
  ...
  factory BookingCompletedProduct.fromJson(Map<String, dynamic> json) =>
      BookingCompletedProduct(
        id: json["id"] ?? 0,
        bookingId: json["booking_id"] ?? "",
