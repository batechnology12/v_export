...
// GetCancelledOrdersModel getCancelledOrdersModelFromJson(String str) => GetCancelledOrdersModel.fromJson(json.decode(str));

// String getCancelledOrdersModelToJson(GetCancelledOrdersModel data) => json.encode(data.toJson());
...
//     factory GetCancelledOrdersModel.fromJson(Map<String, dynamic> json) => GetCancelledOrdersModel(
//         status: json["status"],
//         message: json["message"],
//         data: Data.fromJson(json["data"]),
//     );
...
//     factory Data.fromJson(Map<String, dynamic> json) => Data(
//         orders: List<GetCancelledOrdersModelData>.from(json["orders"].map((x) => GetCancelledOrdersModelData.fromJson(x))),
//     );
...
//     factory GetCancelledOrdersModelData.fromJson(Map<String, dynamic> json) => GetCancelledOrdersModelData(
//         id: json["id"],
//         bookingId: json["booking_id"],
//         userId: json["user_id"],
//         driverId: json["driver_id"],
