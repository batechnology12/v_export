...
GetOngoingOrdersModel getOngoingOrdersModelFromJson(String str) =>
    GetOngoingOrdersModel.fromJson(json.decode(str));

String getOngoingOrdersModelToJson(GetOngoingOrdersModel data) =>
    json.encode(data.toJson());

class GetOngoingOrdersModel {
  bool status;
  String message;
  Data data;

  GetOngoingOrdersModel({
    required this.status,
    required this.message,
    required this.data,
  });

  factory GetOngoingOrdersModel.fromJson(Map<String, dynamic> json) =>
      GetOngoingOrdersModel(
        status: json["status"],
...
class Data {
  List<GetOngoingOrdersModelData> orders;
...
class GetOngoingOrdersModelData {
  int id;
  String bookingId;
  String userId;
  String driverId;
  ...
  List<BookingOngoingDeliveryAddress> bookingDeliveryAddresses;
  ...
  factory GetOngoingOrdersModelData.fromJson(Map<String, dynamic> json) =>
      GetOngoingOrdersModelData(
        ...
        bookingDeliveryAddresses: json["booking_delivery_addresses"] == null
            ? []
            : List<BookingOngoingDeliveryAddress>.from(
                json["booking_delivery_addresses"]
                    .map((x) => BookingOngoingDeliveryAddress.fromJson(x))),
...
class BookingOngoingDeliveryAddress {
  int id;
  String bookingId;
  String customerName;
  ...
  factory BookingOngoingDeliveryAddress.fromJson(Map<String, dynamic> json) =>
      BookingOngoingDeliveryAddress(
        id: json["id"] ?? 0,
        bookingId: json["booking_id"] ?? "",
