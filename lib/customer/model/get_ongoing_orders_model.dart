...
GetOngoingOrdersModel getOngoingOrdersModelFromJson(String str) => GetOngoingOrdersModel.fromJson(json.decode(str));

String getOngoingOrdersModelToJson(GetOngoingOrdersModel data) => json.encode(data.toJson());
...
class GetOngoingOrdersModel {
    ...
    factory GetOngoingOrdersModel.fromJson(Map<String, dynamic> json) => GetOngoingOrdersModel(
        status: json["status"],
        message: json["message"],
        data: Data.fromJson(json["data"]),
    );
